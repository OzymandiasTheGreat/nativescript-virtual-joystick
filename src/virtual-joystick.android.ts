...
import { isFileOrResourcePath, fromFileOrResource } from 'tns-core-modules/image-source';
import * as common from './virtual-joystick.common';
...
export class VirtualJoystick extends common.VirtualJoystickBase {
	...
	[common.imageProp.setNative](value: any) {
		...
		if (isFileOrResourcePath(value)) {
			buttonDrawable = fromFileOrResource(value);
			if (buttonDrawable) {
